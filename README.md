...
![Resposta do login com access_token](./imagens/image.png)

Copie o valor de `access_token`

![Botão Authorize no Swagger](./imagens/image2.png)

Suba a parte superior do sistema e clique em "Authorize"

![Swagger POST /auth/login 2](./imagens/image3.png)

Cole o acess_token na entrada desse modal:

![Swagger POST /auth/login 2](./imagens/image4.png)
